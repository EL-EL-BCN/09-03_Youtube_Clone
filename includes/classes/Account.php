...
class Account {
	...
	} // End of public function UpdateUserDetails
	...
	} // End of public function UpdatePassword
	...
	} // End of private function validateOldPassword
	...
	public function insertUserDetails ($fn, $ln, $un, $em, $pw) {
		...
		return $query->execute();
	} // End of public function insertUserDetails

	private function validateFirstName($fn) {
		if(strlen($fn) > 25 || strlen($fn) < 2) {
			array_push($this->errorArray, Constants::$firstNameCharacters);
		}
	} // End of private function validateFirstName

	private function validateLastName($ln) {
		if(strlen($ln) > 25 || strlen($ln) < 2) {
			array_push($this->errorArray, Constants::$lastNameCharacters);
		}
	} // End of private function validateLastNam

	private function validateUsername($un) {
		if(strlen($un) > 25 || strlen($un) < 5) {
			array_push($this->errorArray, Constants::$usernameCharacters);
			return;
		} // End of private function validateUsername
	...
	private function validateEmails($em, $em2) {
		if($em != $em2) {
			...
			return;
		} // End of private function validateEmails
	...
	} // End of private function validateNewEmail

	private function validatePasswords($pw, $pw2) {
		if($pw != $pw2) {
			array_push($this->errorArray, Constants::$passwordsDoNotMatch);
			return;
		} // End of private function validatePasswords
    ...
    } // End of public function getError
    ...
    } // End of public function getFirstError
