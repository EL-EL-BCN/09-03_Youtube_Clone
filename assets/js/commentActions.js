...
} // End of function dislikeComment

function updateLikesValue(element, num) {
    var likesCountVal = element.text() || 0;
    element.text(parseInt(likesCountVal) + parseInt(num));
} // End of function updateLikesValue
